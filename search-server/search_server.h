...
public:
    ...
    void RemoveDocument(std::execution::sequenced_policy pol, int document_id);

    void RemoveDocument(std::execution::parallel_policy pol, int document_id);
...
private:
    ...
    std::map<int, std::map<std::string_view, double>> ids_to_words_freqs_;
